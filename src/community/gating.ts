 ...
 * Vaquill AI's hosted data or account throws REQUIRES_ACCOUNT. These helpers let the
...
/** Surfaces that only make sense with a hosted Vaquill AI account. */
 ...
 * CourtListener). Statute resolution still needs Vaquill AI's corpus and stays off.
 */
